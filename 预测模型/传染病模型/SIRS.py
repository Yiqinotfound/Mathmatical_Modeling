...
def diff_eqs(y,t):
    dy=np.zeros(3)
    dy[0] = -beta*y[0]*y[1] +alpha*y[2]
    dy[1] = beta*y[0]*y[1] -gamma*y[1]
    dy[2] = gamma*y[1] - alpha*y[2]
    return dy
